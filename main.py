...
# SocialBot v0.9.1
# CAMBIOS vs v0.9.0:
#   - MIGRACIÓN: SQLite → PostgreSQL (psycopg2)
#   - Placeholders ? → %s
#   - AUTOINCREMENT → SERIAL
#   - INSERT OR REPLACE → INSERT ... ON CONFLICT DO UPDATE
#   - Migraciones con manejo de errores de Postgres
#   - Removido: Path("data").mkdir (Postgres no usa archivos locales)
# ============================================================
...
class Database:
    def __init__(self):
        # Render inyecta DATABASE_URL automáticamente como variable de entorno
    ...
    def _init_db(self):
        with self._get_connection() as conn:
            ...
            # En Postgres usamos DO $$ ... $$ para ignorar errores de columna duplicada
            migrations = [
